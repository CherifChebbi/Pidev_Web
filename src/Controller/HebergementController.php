...
class HebergementController extends AbstractController
{
    ...
    public function index(HebergementRepository $hebergementRepository,ReservationRepository $rep): Response
    {
    ...
    public function search(Request $request,HebergementRepository $hebergementRepository,ReservationRepository $rep): Response
    {
